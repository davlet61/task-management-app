...
export const UserSolid = ({ w, h, click }: IUserSolidProps) => (
  <button
    type="button"
    onClick={click}
  >
    <svg
      ...
      className={`h-${h} w-${w} cursor-pointer`}
      viewBox="0 0 20 20"
      fill="white"
    >
...
export const Spinner = () => (
  <svg role="status" className="inline w-10 md:w-16 h-10 md:h-16 mr-2 text-gray-200 animate-spin dark:text-gray-400 fill-red-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
